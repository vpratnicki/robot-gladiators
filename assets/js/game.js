...
var fightOrSkip = function() {
  ...
  if (promptFight ==="skip") {
    ...
    if (confirmSkip) {
      window.alert(playerInfo.name + " has decided to ship this fight. Goodbye!");
...
var fight = function (enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    console.log(playerInfo.name + " attacked " + enemy.name + ". " + enemy.name + " now has " + enemy.health + " healh remaining.");
...
var startGame = function () {
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    if (playerInfo.health > 0) {
      ...
      // pick new enemy to fight nased on the index of the enemyNames array
...
var shop = function () {
  ...
  var shopOptionPrompt = window.prompt("Would you like to REFILL you health, UPGRADE your attack, or LEAVE the stoe? Please enter one: 'refill', 'upgrade', or 'leave' to make a choice.");
